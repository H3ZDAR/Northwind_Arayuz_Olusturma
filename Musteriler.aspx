...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div class="row">
        <div class="col-md-12">
            <div class="x_panel">
                <div class="x_title">
                    <h2>Müşteri Ekleme Paneli</h2>
                    <div class="clearfix"></div>
                </div>
                <div class="x_content">
                    <div class="col-md-6 col-sm-6 mb-3">
                        <asp:TextBox ID="txtCustomerID" runat="server" class="form-control" placeholder="Müşteri No"></asp:TextBox>
                    </div>
										...
										<asp:Repeater ID="rptMusteriler" runat="server" OnItemCommand="rptMusteriler_ItemCommand">
											<ItemTemplate>
												<tr>
													...
													<td><%#Eval("Fax") %></td>
													<td>
														<asp:LinkButton ID="lnkbtn" class="btn btn-success btn-sm" CommandName="Sec" CommandArgument='<%#Eval("CustomerID") %>' runat="server">Güncelle</asp:LinkButton>
													</td>
													<td>
														<asp:LinkButton ID="LinkButton2" class="btn btn-danger btn-sm" CommandName="Sil" CommandArgument='<%#Eval("CustomerID") %>' runat="server">Sil</asp:LinkButton>
													</td>
												</tr>
											</ItemTemplate>
										</asp:Repeater>
